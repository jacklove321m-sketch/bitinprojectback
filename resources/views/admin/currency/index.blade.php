...
@section('scripts')
    <script type="text/html" id="barDemo">
        ...
        @{{# } }}
        <a class="layui-btn layui-btn-xs" lay-event="matchedit">交易对编辑</a>
    </script>
    ...
    <script type="text/html" id="is_transfer">
     ...
     <script type="text/html" id="is_class">
        @{{d.is_class==2 ? '<span class="layui-badge layui-bg-green">'+'加密货币'+'</span>' : '' }}
        @{{d.is_class==3 ? '<span class="layui-badge layui-bg-red">'+'期货'+'</span>' : '' }}
        @{{d.is_class==0 ? '<span class="layui-badge layui-bg-red">'+'外汇'+'</span>' : '' }}
        @{{d.is_class==6 ? '<span class="layui-badge layui-bg-red">'+'股票'+'</span>' : '' }}
        @{{d.is_class==9 ? '<span class="layui-badge layui-bg-red">'+'ETF'+'</span>' : '' }}
    </script>
    ...
    <script>
        layui.use(['table','form'], function(){
            ...
            table.render({
                ...
                ,cols: [[ //表头
                    ...
                    ,{field: 'is_class', title: '分类', width:90, templet: '#is_class'}
                    ...
                    ,{field: 'is_open', title: '开市', width:80, templet: '#legal'}
        ...
        //监听是否购买保险操作
            ...
            table.on('tool(test)', function(obj){
                ...
                } else if (obj.event == 'matchedit') {
                    layer.open({
                        title: '交易对编辑'
                        ,type: 2
                        ,content: '/admin/currency/match_edit/' + data.id
                        ,area: ['960px', '600px']
                    });
                } 
            });
