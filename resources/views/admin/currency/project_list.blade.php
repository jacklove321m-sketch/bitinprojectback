...
@endsection
 <!--   <a class="layui-btn layui-bg-red layui-btn-xs" lay-event="del"><i class="layui-icon layui-icon-friends"></i>删除</a> -->
@section('scripts')
        ...
        layui.use(['table','form'], function(){
            ...
            table.render({
                ...
                ,cols: [[ //表头
                    ...
                    ,{field: 'end_at', title: '结束时间',width:120}
                ...
                if(obj.event == 'check'){
                 ...
                 if(obj.event == 'del'){
                    var index = layer.open({
                        title:'删除订单'
                        ,type:2
                        ,content: '/admin/currency/project/order/del?id='+data.id
                        ,area: ['100%', '100%']
                        ,maxmin: true
                        ,anim: 3
                    });
