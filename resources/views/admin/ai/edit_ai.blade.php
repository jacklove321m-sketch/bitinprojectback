...
@section('page-content')
           ...
           <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <select name='name'>
                             ...
                             <option  value="{{$userleve->name}}" class='layui-option'  @if (isset($userleve->name)) {{ $userleve->name == $results->name ? 'selected' : '' }} @else checked @endif>{{ $userleve->name }}</option>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-form-item">
         ...
         <div class="layui-form-item">
            <label class="layui-form-label">最大回撤率%</label>
            <div class="layui-input-block">
