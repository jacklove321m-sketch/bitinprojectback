...
<div class="layui-form">
    <!--<button class="layui-btn layui-btn-normal layui-btn-radius" onclick="layer_show('添加双币项目','{{url('admin/ai/add')}}')">添加双币项目</button>-->
    ...
    <script>
        layui.use(['table','form'], function(){
            ...
            var orderList = table.render({
                elem: '#orderList'
                ,toolbar: '#toolbar'
                ,url: '{{url('admin/ai/order_lists')}}' //数据接口
                ,page: true //开启分页
                // ,id:'mobileSearch'
                ,cols: [[ //表头
                    ...
                    ,{field: 'user_id', title: '用户ID', minWidth: 80}
                     ,{field: 'day', title: '运行时长', minWidth:110}
                  //  ,{field: 'name', title: '量化名称', minWidth:200}
                    ,{field: 'orderid', title: '订单ID', minWidth:200}
                    ,{field: 'order_rate', title: '最大收益率%', minWidth:110}
                   
                    ,{field: 'amount', title: '投入金额', minWidth:110}
