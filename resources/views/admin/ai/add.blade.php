    ...
    <form class="layui-form" action="">
       ...
       <!-- <div class="layui-form-item">
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-form-item">
                        <label for="currency_id" class="layui-form-label">AI组合</label>
                        <div class="layui-input-block">
          ...
          <div class="layui-form-item">
                        <label for="currency_id" class="layui-form-label">会员等级</label>
                        <div class="layui-input-block">
                            <select name='name'>
                              @foreach ($userlevel as $userleve)
                             <option  value="{{$userleve->name}}" class='layui-option'>{{ $userleve->name }}</option>
        ...
        -->
         <div class="layui-form-item">
            <label class="layui-form-label">最大服务费</label>
            <div class="layui-input-block">
