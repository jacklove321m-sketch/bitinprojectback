...
<script type="text/html" id="img">
    ...
    @{{# if(d.img){ }}
        <img src="@{{d.img}}" style="width: 80px" onmouseover="layer.tips('<div style=\'background-color: #fff;\'><img style=\'max-width: 100px;\' src=@{{d.img}}></div>',this,{tips: [1, '#fff']});" onmouseout="layer.closeAll();">
    @{{# } }}
    ...
    layui.use(['element', 'form', 'layer', 'table'], function () {
        ...
        var user_table = table.render({
            ...
            ,cols: [[
                ...
                ,{field:'img', title:'会员卡图', width:120,templet:"#img"}
