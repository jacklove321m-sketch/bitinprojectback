...
@section('page-content')
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">当前信用分</label>
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">调整信用分</label>
            <div class="layui-input-block">
                <input type="text" name="change" autocomplete="off" placeholder="请输入信用分" class="layui-input" value="">
            </div>
        </div>
        <div class="layui-form-item">
