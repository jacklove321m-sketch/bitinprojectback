...
<div class="layui-form">
    <button class="layui-btn layui-btn-normal layui-btn-radius" onclick="layer_show('添加量化项目','{{url('admin/dual/add')}}')">添加量化项目</button>
        ...
        layui.use(['table','form'], function(){
            ...
            var demo = table.render({
                ...
                ,cols: [[ //表头
                    ...
                    ,{field: 'invest', title: '投资组合', minWidth:200}
                    ,{field: 'days', title: '量化天数', minWidth:100}
                    ,{field: 'rate', title: '起始回报率%', minWidth: 115}
                    ,{field: 'ratemax', title: '最大回报率%', minWidth: 115}
                    ,{field: 'amount', title: '起始金额', minWidth:100}
                    ,{field: 'amax', title: '最大金额', minWidth:100}
                    ,{field: 'total_number', title: '次数', minWidth:100}
                    ,{field: 'commission', title: '手续费', minWidth:100}
