            ...
            <div class="layui-tab">
                ...
                <div class="layui-tab-content">
                    ...
                    <div class="layui-tab-item">
                        ...
                        <div class="layui-form-item">
                            <label class="layui-form-label">验证码是否开启</label>
                            <div class="layui-input-block">
                                <div class="layui-input-inline">
                        ...
                        <div class="layui-form-item">
                         ...
                         <div class="layui-form-item">
                            <label class="layui-form-label">是否开启实名认证</label>
                            <div class="layui-input-block">
                                <div class="layui-input-inline">
                                    <input type="radio" name="realname" value="1" title="是" @if (isset($setting['realname'])) {{$setting['realname'] == 1 ? 'checked' : ''}} @endif >
                                    <input type="radio" name="realname" value="0" title="否" @if (isset($setting['realname'])) {{$setting['realname'] == 0 ? 'checked' : ''}} @else checked @endif >
                                </div>
                            </div>
                        </div>
                          ...
                          <div class="layui-form-item">
                            <label class="layui-form-label">是否开启DAPP模拟</label>
                            <div class="layui-input-block">
                                <div class="layui-input-inline">
                                    <input type="radio" name="DAPP_DEMO" value="1" title="是" @if (isset($setting['DAPP_DEMO'])) {{$setting['DAPP_DEMO'] == 1 ? 'checked' : ''}} @endif >
                                    <input type="radio" name="DAPP_DEMO" value="0" title="否" @if (isset($setting['DAPP_DEMO'])) {{$setting['DAPP_DEMO'] == 0 ? 'checked' : ''}} @else checked @endif >
                                </div>
                            </div>
                        </div>
                        
                         <div class="layui-form-item">
                            <label class="layui-form-label">是否开启H5模拟</label>
                            <div class="layui-input-block">
                                <div class="layui-input-inline">
                                    <input type="radio" name="H5_DEMO" value="1" title="是" @if (isset($setting['H5_DEMO'])) {{$setting['H5_DEMO'] == 1 ? 'checked' : ''}} @endif >
                                    <input type="radio" name="H5_DEMO" value="0" title="否" @if (isset($setting['H5_DEMO'])) {{$setting['H5_DEMO'] == 0 ? 'checked' : ''}} @else checked @endif >
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="layui-form-item">
                            <label class="layui-form-label">是否开启上传背面照片</label>
                            <div class="layui-input-block">
                                <div class="layui-input-inline">
                                    <input type="radio" name="reverse_radio" value="1" title="是" @if (isset($setting['reverse_radio'])) {{$setting['reverse_radio'] == 1 ? 'checked' : ''}} @endif >
                                    <input type="radio" name="reverse_radio" value="0" title="否" @if (isset($setting['reverse_radio'])) {{$setting['reverse_radio'] == 0 ? 'checked' : ''}} @else checked @endif >
                                </div>
                            </div>
                        </div>
                        
                         <div class="layui-form-item">
                            <label class="layui-form-label">是否开启示例</label>
                            <div class="layui-input-block">
                                <div class="layui-input-inline">
                                    <input type="radio" name="example_radio" value="1" title="是" @if (isset($setting['example_radio'])) {{$setting['example_radio'] == 1 ? 'checked' : ''}} @endif >
                                    <input type="radio" name="example_radio" value="0" title="否" @if (isset($setting['example_radio'])) {{$setting['reverse_radio'] == 0 ? 'checked' : ''}} @else checked @endif >
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="layui-form-item">
                            <label class="layui-form-label">是否开启设置登录密码</label>
                            <div class="layui-input-block">
                                <div class="layui-input-inline">
                                    <input type="radio" name="password_radio" value="1" title="是" @if (isset($setting['password_radio'])) {{$setting['password_radio'] == 1 ? 'checked' : ''}} @endif >
                                    <input type="radio" name="password_radio" value="0" title="否" @if (isset($setting['password_radio'])) {{$setting['password_radio'] == 0 ? 'checked' : ''}} @else checked @endif >
                                </div>
                            </div>
                        </div> 
                        
                         <div class="layui-form-item">
                            <label class="layui-form-label">是否开启邮箱验证</label>
                            <div class="layui-input-block">
                                <div class="layui-input-inline">
                                    <input type="radio" name="email_radio" value="1" title="是" @if (isset($setting['email_radio'])) {{$setting['email_radio'] == 1 ? 'checked' : ''}} @endif >
                                    <input type="radio" name="email_radio" value="0" title="否" @if (isset($setting['email_radio'])) {{$setting['email_radio'] == 0 ? 'checked' : ''}} @else checked @endif >
                                </div>
                            </div>
                        </div> 
                        ...
                        <div class="layui-form-item">
                            <label class="layui-form-label">模拟盘初始资金</label>
                            <div class="layui-input-block">
                                <input type="text" name="init_balance" autocomplete="off" class="layui-input"
                                   value="@if(isset($setting['init_balance'])){{$setting['init_balance'] ?? ''}}@endif">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="web_mail" autocomplete="off" class="layui-input"
                                       value="@if(isset($setting['web_mail'])){{$setting['web_mail'] ?? ''}}@endif">
                            </div>
                        </div>
                        <!--<div class="layui-form-item">-->
                    ...
                    <div class="layui-tab-item">
                        ...
                        <div class="layui-form-item">
                            <label class="layui-form-label">永续交易委托功能</label>
                            <div class="layui-input-block">
                                <div class="layui-input-inline">
                                ...
                                <div class="layui-form-mid layui-word-aux">打开后前台可以进行永续交易委托,即限价交易</div>
                            </div>
                        </div>
                        <div class="layui-form-item">
                    ...
                    <div class="layui-tab-item">
                        ...
                        <div class="layui-form-item">
                         ...
                         <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <div class="layui-input-inline">
                                    <input type="radio" name="facebook" value="1" title="开启" @if (isset($setting['facebook'])) {{$setting['facebook'] == 1 ? 'checked' : ''}} @endif >
                                    <input type="radio" name="facebook" value="0" title="关闭" @if (isset($setting['facebook'])) {{$setting['facebook'] == 0 ? 'checked' : ''}} @else checked @endif >
                                </div>
                                <div class="layui-input-block">
                                    <input type="text" name="facebook_url" placeholder="请输入链接" autocomplete="off" class="layui-input"
                                           value="@if(isset($setting['facebook_url'])){{$setting['facebook_url'] ?? ''}}@endif">
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <div class="layui-input-inline">
                                    <input type="radio" name="twitter" value="1" title="开启" @if (isset($setting['twitter'])) {{$setting['twitter'] == 1 ? 'checked' : ''}} @endif >
                                    <input type="radio" name="twitter" value="0" title="关闭" @if (isset($setting['twitter'])) {{$setting['twitter'] == 0 ? 'checked' : ''}} @else checked @endif >
                                </div>
                                <div class="layui-input-block">
                                    <input type="text" name="twitter_url" placeholder="请输入链接" autocomplete="off" class="layui-input"
                                           value="@if(isset($setting['twitter_url'])){{$setting['twitter_url'] ?? ''}}@endif">
                                </div>
                            </div>
                        </div>
                       <!-- <div class="layui-form-item">
