...
class Kernel extends ConsoleKernel
{
    ...
    protected $commands = [
        ...
        Commands\SyncExternalMarket::class,
    ];
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command('market:sync-external')->everyMinute()->withoutOverlapping()->appendOutputTo('./storage/logs/market_sync_external.log'); //同步外部行情
